...
\cventry{9/2010--Σήμερα}{Τμήμα Μηχανικών Πληροφορικής Τ.Ε.}{Τεχνολογικό Εκπαιδευτικό \newline Ίδρυμα Κεντρικής Μακεδονίας, Σέρρες}{}{}{} % Arguments not required can be left empty
...
\cvitem{Γλώσσες \newline{}Προγραμματισμού}{\textsc{\latintext C, C++, SHELL SCRIPT, JAVASCRIPT, C\#, JAVA, PYTHON, PHP, SQL, PL\textbackslash SQL, OCTAVE}\newline{}}

\cvitem{Βάσεις}{\textsc{\latintext ORACLE, MYSQL, MONGODB, NEO4J}\newline{}}

\cvitem{Εργαλεία}{\textsc{\latintext J2EE, NETBEANS, ECLIPSE, VISUAL STUDIO, GIT, INTELLIJ IDEA, SUBLIME, ATOM, MATLAB, ANDROID SDK, \LaTeX, JOOMLA, WORDPRESS, ORACLE GOLDENGATE VERIDATA, MICROSOFT OFFICE, LIBRE OFFICE, PUTTY} κτλ.\newline{}}

\cvitem{\latintext Frameworks}{\textsc{\latintext SPRING, HIBERNATE, BOTTLE, CORDOVA, ANGULARJS, IONIC, .NET, DJANGO, JUNIT, DBUNIT, MOCKITO, MAVEN}}
